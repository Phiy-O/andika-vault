...
export function ContentPage({ eyebrow, title, description, children }: ContentPageProps) {
  return (
    <>
      <header className="mx-auto max-w-[1280px] py-[150px] px-[10vw] pb-[110px] max-md:py-[100px] max-md:px-[6vw] max-md:pb-[75px]">
      ...
      <div className="mx-auto max-w-[1280px] py-0 px-[10vw] max-md:px-[6vw]">{children}</div>
      <div className="mx-auto max-w-[1280px] py-0 px-[10vw] pb-[130px] max-md:px-[6vw] max-md:pb-[90px]">
